...
test('Gets Jest configuration once Babel configuration is set', () => {
  ...
  var expected_result = {
    ...
    rootDir: '/Volumes/DATA/projects/berun/packages/preset-fuse-box-react',
    moduleNameMapper: {
    ...
    transform: {
      '^.+\\.(ts|tsx|js|jsx|mjs)$':
        '/Volumes/DATA/projects/berun/node_modules/@berun/runner-jest/src/transforms/babelTransform.js',
      '^(?!.*\\.(ts|tsx|js|jsx|mjs|css|json|graphql)$)':
        '/Volumes/DATA/projects/berun/node_modules/@berun/runner-jest/src/transforms/fileTransform.js',
      '^.+\\.css$':
        '/Volumes/DATA/projects/berun/node_modules/@berun/runner-jest/src/transforms/cssTransform.js'
    },
    globals: {
      'ts-jest': {
        skipBabel: true
