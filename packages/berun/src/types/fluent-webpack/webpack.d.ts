...
declare type Tapable = any;
declare type HookMap = any;
declare type SyncBailHook = any;
declare type SyncHook = any;
declare type SyncWaterfallHook = any;
declare type AsyncParallelHook = any;
declare type AsyncSeriesHook = any;
declare type AsyncSeriesWaterfallHook = any;
export = webpack;
declare function webpack(options: webpack.Configuration | webpack.ConfigurationFactory, handler: webpack.Compiler.Handler): webpack.Compiler.Watching | webpack.Compiler;
declare function webpack(options?: webpack.Configuration): webpack.Compiler;
declare function webpack(options: webpack.Configuration[] | webpack.MultiConfigurationFactory, handler: webpack.MultiCompiler.Handler): webpack.MultiWatching | webpack.MultiCompiler;
...
declare namespace webpack {
    ...
    type ConfigurationFactory = ((env: string | Record<string, boolean | number | string>, args: CliConfigOptions) => Configuration | Promise<Configuration>);
    type MultiConfigurationFactory = ((env: string | Record<string, boolean | number | string>, args: CliConfigOptions) => Configuration[] | Promise<Configuration[]>);
    interface Entry {
    ...
    type RuleSetCondition = RegExp | string | ((path: string) => boolean) | RuleSetConditions | {
        /**
         * Logical AND
         */
    ...
    namespace Options {
        type Devtool = 'eval' | 'inline-source-map' | 'cheap-eval-source-map' | 'cheap-source-map' | 'cheap-module-eval-source-map' | 'cheap-module-source-map' | 'eval-source-map' | 'source-map' | 'nosources-source-map' | 'hidden-source-map' | 'nosources-source-map' | 'inline-cheap-source-map' | 'inline-cheap-module-source-map' | '@eval' | '@inline-source-map' | '@cheap-eval-source-map' | '@cheap-source-map' | '@cheap-module-eval-source-map' | '@cheap-module-source-map' | '@eval-source-map' | '@source-map' | '@nosources-source-map' | '@hidden-source-map' | '@nosources-source-map' | '#eval' | '#inline-source-map' | '#cheap-eval-source-map' | '#cheap-source-map' | '#cheap-module-eval-source-map' | '#cheap-module-source-map' | '#eval-source-map' | '#source-map' | '#nosources-source-map' | '#hidden-source-map' | '#nosources-source-map' | '#@eval' | '#@inline-source-map' | '#@cheap-eval-source-map' | '#@cheap-source-map' | '#@cheap-module-eval-source-map' | '#@cheap-module-source-map' | '#@eval-source-map' | '#@source-map' | '#@nosources-source-map' | '#@hidden-source-map' | '#@nosources-source-map' | boolean;
    ...
    namespace compilation {
        ...
        class Chunk {
            ...
            addMultiplierAndOverhead(size: number, options: {
    ...
    class DefinePlugin extends Plugin {
        ...
        static runtimeValue(fn: ({ module }: {
            module: compilation.Module;
        }) => DefinePlugin.CodeValuePrimitive, fileDependencies?: string[]): DefinePlugin.RuntimeValue;
    }
    namespace DefinePlugin {
        class RuntimeValue {
            constructor(fn: ({ module }: {
                module: compilation.Module;
            }) => CodeValuePrimitive, fileDependencies?: string[]);
        ...
        type CodeValueObject = CodeValuePrimitive | {
            [key: string]: CodeValueObject;
        };
    }
    ...
    namespace loader {
        interface Loader extends Function {
            (this: LoaderContext, source: string | Buffer, sourceMap?: any): string | Buffer | void | undefined;
            /**
        ...
        type loaderCallback = (err: Error | undefined | null, content?: string | Buffer, sourceMap?: any) => void;
        interface LoaderContext {
             ...
             */
            loadModule(request: string, callback: (err: Error | null, source: string, sourceMap: any, module: Module) => void): any;
            /**
    ...
    namespace Template {
        ...
        function renderChunkModules(chunk: compilation.Chunk, filterFn: (module: compilation.Module, num: number) => boolean, moduleTemplate: compilation.ModuleTemplate, dependencyTemplates: any, prefix?: string): any;
    }
    /** @deprecated */
    namespace compiler {
