 ...
 */
module.exports.ruleParser = (berun, options) => {
 ...
 */
module.exports.ruleMjs = (berun, options) => {
  berun.webpack.module
    .rule('mjs')
    .test([/\.mjs$/])
 ...
 */
module.exports.ruleMainImage = (berun, options) => {
  berun.webpack.module
    .rule('main')
    .oneOf('image')
 ...
 */
module.exports.ruleMainCompile = (berun, options) => {
  berun.webpack.module
    .rule('main')
    .oneOf('compile')
    .test(/\.(js|jsx|ts|tsx)$/)
 ...
 */
module.exports.ruleMainStatic = (berun, options) => {
  berun.webpack.module
    .rule('main')
    .oneOf('static')
...
module.exports.ruleMainSvg = (berun, options) => {
  berun.webpack.module
    .rule('main')
    .oneOf('svg')
    .test(/\.svg$/)
