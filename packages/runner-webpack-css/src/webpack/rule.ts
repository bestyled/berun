...
const getStyleLoaders = (options, cssOptions, preProcessor?) => {
  const loaders = { use: {} as any }

  if (options.ISPRODUCTION) {
    loaders.use.minicss = { loader: MiniCssExtractPlugin.loader }
  } else {
    loaders.use.style = { loader: require.resolve('style-loader') }
  }
 ...
 */
export const ruleMainPostCss = (berun: Berun, options) => {
...
export const ruleMainCssModule = (berun: Berun, options) => {
  berun.webpack.module
    .rule('main')
    .oneOf('css-module')
    .test(cssModuleRegex)
 ...
 */
export const ruleMainSass = (berun: Berun, options) => {
  berun.webpack.module
    .rule('main')
    .oneOf('sass')
    .test(sassRegex)
 ...
 */
export const ruleMainSassModule = (berun: Berun, options) => {
  berun.webpack.module
    .rule('main')
    .oneOf('sass-module')
