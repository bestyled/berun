...
With `@berun/template-react-ts` this requires adjusting a single `berun.config.js` file, regardless of whether
...
module.exports = {
  use: [
    '@berun/preset-fuse-box-react-ts',  /* REMOVED '@berun/preset-react-ts', */
    '@berun/runner-tslint',
