...
This runner creates the necessary Webpack configuration and build tasks to
...
* Supports different build engines (Webpack, etc.) with hot reloading for rapid development
* Streamlined HTML plugins for Webpack, etc. with support for &lt;Head > sections, global CSS
