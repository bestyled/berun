...
const validateBoolOption = (name, value, defaultValue) => {
  ...
  if (typeof value !== 'boolean') {
    throw new Error(`Preset @berun/babel-preset-react-app: '${name}' option must be a boolean.`);
  }
  ...
  return {
    ...
    plugins: [
      ...
      // https://babeljs.io/docs/en/babel-plugin-transform-runtime
        (isEnvTest || isEnvProduction) && [ require('@babel/plugin-transform-runtime').default,
        {
          corejs: false,
